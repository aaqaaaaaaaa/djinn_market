...
abstract class AppTextStyles {
  ...
  static const String fontFamily = 'PPNeue';
  ...
  static TextStyle body15w7 = TextStyle(
      ...
      fontSize: 15.sp,
      color: AppColors.black);
  static TextStyle body15w8 = TextStyle(
      fontFamily: fontFamily,
      fontWeight: FontWeight.w800,
      fontStyle: FontStyle.normal,
      fontSize: 15.sp,
  ...
  static TextStyle body20w6 = TextStyle(
      ...
      fontSize: 20.sp,
      color: AppColors.black);
  static TextStyle body20w7 = TextStyle(
      fontFamily: fontFamily,
      fontWeight: FontWeight.w600,
      fontStyle: FontStyle.normal,
      fontSize: 20.sp,
  ...
  static TextStyle body20w8 = TextStyle(
      fontFamily: fontFamily,
      fontWeight: FontWeight.w800,
      fontStyle: FontStyle.normal,
      fontSize: 20.sp,
      color: AppColors.black);
  static TextStyle body28w7 = TextStyle(
      fontFamily: fontFamily,
      fontWeight: FontWeight.w700,
      fontStyle: FontStyle.normal,
      fontSize: 28.sp,
  ...
  static TextStyle body25w4 = TextStyle(
      ...
      fontSize: 25.sp,
      color: AppColors.black);
  static TextStyle body25w7 = TextStyle(
      fontFamily: fontFamily,
      fontWeight: FontWeight.w700,
      fontStyle: FontStyle.normal,
      fontSize: 25.sp,
  ...
  static TextStyle body22w5 = TextStyle(
      ...
      fontSize: 22.sp,
      color: AppColors.black);
  static TextStyle body45w9 = TextStyle(
      fontFamily: fontFamily,
